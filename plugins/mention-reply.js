  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(
        config.MENU_IMAGE_URL || "https://files.catbox.moe/zvrvm9.jpg",
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "SPARTA-MD 💫",
            body: config.DESCRIPTION || "𝐒𝐏𝐀𝐑𝐓𝐀-𝐌𝐃 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/zvrvm9.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/254795452444",
