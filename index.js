const {
  ...
  const ownerNumber = ['254795452444']
...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
    if (config.SESSION_ID && config.SESSION_ID.trim() !== "") {
        const sessdata = config.SESSION_ID.replace("SPARTA-MD~", '');
        try {
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there SPARTA-MD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet SPARTA-MD WhatsApp Bot.\n\n *Thanks for using SPARTA-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb0SOLfBfxoG91DqFd0a \n\n- *YOUR PREFIX:* = ${prefix}\n\nDon't forget to give star to repo ⬇️\n\nhttps://github.com/M-28/SPARTA-MD\n\n> © 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚂𝙿𝙰𝚁𝚃𝙰-𝟸𝟾 ❣️ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/hheb1q.jpg` }, caption: up })
  }
  })
...
if (senderNumber.includes("254795452444") && !isReact) {
